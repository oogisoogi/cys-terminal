...
| 축 | 결정 |
|---|---|
| 1차 사용자 | **둘 다** — 오너 본인 + 배포 앱의 일반 사용자가 **공용 오버라이드 계층** 사용 |
...
- autopilot denylist(로드맵 이탈·헌법 변경·외부발행·비가역 삭제·오너 보유결정) 불변
- recovery 프로토콜·SESSION_STATE 체크포인트 불변
- kill-switch(오너 입력=즉시 일시정지) 불변
